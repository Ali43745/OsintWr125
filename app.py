...
def load_data():
    query = """
    SELECT Weapon_Name,Type, Weapon_Category, Origin, Development, Caliber, Length, Barrel_Length, Weight, Width, Height, Downloaded_Image_Name FROM dbo_final_text1
    """
