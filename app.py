...
def load_data():
    query = """
    SELECT Weapon_Name, Source, Type, Weapon_Category, Origin, Development, Caliber, Length, Barrel_Length, Weight, Width, Height, Action, Beam, Downloaded_Image_Name, bert_embeddings FROM dbo_final_text1
    """
